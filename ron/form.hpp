...
const std::unordered_map<Uuid, FORM> UUID2FORM = {
    {ZERO_FORM_UUID, ZERO_RAW_FORM},
    {YARN_FORM_UUID, YARN_RAW_FORM},
    {LOG_FORM_UUID, LOG_RAW_FORM},
    {TAIL_FORM_UUID, TAIL_RAW_FORM},
    {PATCH_FORM_UUID, PATCH_RAW_FORM},
    {SPAN_FORM_UUID, SPAN_RAW_FORM},
    {CHAIN_FORM_UUID, CHAIN_RAW_FORM},
    {GRAPH_FORM_UUID, GRAPH_RAW_FORM},
    {META_FORM_UUID, META_META_FORM},
    {PREV_FORM_UUID, PREV_META_FORM},
    {OBJ_FORM_UUID, OBJ_META_FORM},
    {SHA3_FORM_UUID, SHA3_META_FORM},
    {VV_FORM_UUID, VV_META_FORM},
    {LWW_FORM_UUID, LWW_RDT_FORM},
    {RGA_FORM_UUID, RGA_RDT_FORM},
    {MX_FORM_UUID, MX_RDT_FORM},
