...
struct stringbuf {
  ...
  inline Value Add(const char *str) { return Add(str, (fsize_t)strlen(str)); }
...
template <typename Builder>
void AddOp(Builder &builder, const Uuid &id, const Uuid &ref, const char *val0,
           const char *val1) {
...
template <typename Builder>
inline void AddOp(Builder &builder, const char *id, const char *ref,
                  const char *val0, const char *val1) {
